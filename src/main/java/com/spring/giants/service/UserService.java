...
public class UserService {
    ...
    public void sendMail(MailDto mailDto) {
        ...
        try {
            ...
            String content = "<h3 style='padding: 1rem; text-align: center;'>회원가입 인증번호입니다.</h3><br><h1 style='padding: 2.5rem; background: #f1f1f1; text-align: center; color: #dc3545;'>"+secreteKey+"</h1>";
